...
fetchDatafromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function (movie) {
  ...
  <div class="detail-box">
      <div class="detail-content">
          ...
          <div class="meta-list">
              <div class="meta-item">
                  <img src="star.png" alt="rating" width="20" height="20">
      ...
      <div class="slider-list">
          ...
          <a href="https://www.youtube.com/results?search_query=${title}+trailer" class="btn watchtrailer">
                <img src="play_circle.png" alt="play circle" width="24" height="24" aria-hidden="true">
                <span class="span" style="color : red ;">Watch Trailer Now</span>
            </a>
          </div>
      </div>
  </div>
...
const filterVideos = function (videoList) {
  ...
  for (const { key, name } of filterVideos(videos)) {
    ...
    videocard.innerHTML =
      `
      <iframe width ="500" height="294" src="https://www.youtube.com/embed/${key}" frameborder="0" allowfullscreen="1" title="${title}" class = "img-cover" loading="lazy"></iframe> 
